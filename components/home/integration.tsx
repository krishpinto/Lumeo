        ...
        <div className="relative flex flex-col items-center justify-center w-full py-20 scale-">
            ...
            <Container delay={0.3}>
                <div className="relative hidden lg:flex items-center justify-center overflow-visible">
                    <div className="absolute top-1/2 -translate-y-1/2 right-1/4 w-3/5 h-14 lg:h-20 bg-gradient-to-r from-purple-800 to-indigo-500 rounded-full -rotate-12 blur-[6.5rem] -z-10"></div>
                    ...
                    <div className="absolute z-20 flex items-center justify-center group">
                        {/* Replaced the previous logo with your custom logo */}
                        <Image 
                            src="/image 4.svg"
                            alt="Company Logo"
                            width={106}

...
import { BENIFITS } from "@/lib/benifits";
            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Explore the powerful features and advantages that Lumeo offer to help you grow your social media presence
                    </p>
                </div>
            </Container>
            <Container>

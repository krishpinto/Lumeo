...
export const COMPANIES = [
  {
    name: "Asana",
    logo: "/company-01.svg", // Updated to use the correct path
  },
  {
    name: "Tidal",
    logo: "/company-02.svg", // Updated to use the correct path
  },
  {
    name: "Innovaccer",
    logo: "/company-03.svg", // Updated to use the correct path
  },
  {
    name: "Linear",
    logo: "/company-04.svg", // Updated to use the correct path
  },
  {
    name: "Raycast",
    logo: "/company-05.svg", // Updated to use the correct path
  },
  {
    name: "Labelbox",
    logo: "/company-06.svg", // Updated to use the correct path
  },
] as const;

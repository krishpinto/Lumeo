  ...
  return (
    <div className="space-y-8 pt-1">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl pl-2 font-bold tracking-tight">Dashboard</h1>
          <p className="text-muted-foreground pl-2">
            Welcome back, {currentUser.displayName || "User"}! Manage your
            events here.
          </p>
        </div>
        <Button asChild>
          ...
          events.map((event) => (
            ...
            >
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  {event.eventType || "No type specified"}
                </CardDescription>
              </CardHeader>
